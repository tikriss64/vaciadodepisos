...
function openGoogleReviews() {
    document.getElementById('googleReviewsModal').style.display = 'block';
    loadGoogleReviews();
}

function closeGoogleReviews() {
    document.getElementById('googleReviewsModal').style.display = 'none';
}

function loadGoogleReviews() {
    // Aquí puedes agregar reseñas reales manualmente
    setTimeout(() => {
        document.getElementById('reviewsContainer').innerHTML = `
            <div class="review-item-modal">
                ...
                <p class="review-text">"Servicio excelente y profesional. Vaciamos el piso completo en un día. Muy recomendable!"</p>
            </div>
            <div class="review-item-modal">
                <div class="review-header">
                    <div class="reviewer-info">
                ...
                <p class="review-text">"Muy contenta con el trabajo. Rápidos, eficientes y precios justos. Los volvería a contratar."</p>
            </div>
            <div class="review-item-modal">
                <div class="review-header">
                    <div class="reviewer-info">
                        <h4>Carlos Méndez</h4>
                        <div class="review-date">Agosto 2024</div>
                    </div>
                    <div class="review-stars">⭐⭐⭐⭐⭐</div>
                </div>
                <p class="review-text">"Profesionales y serios. El piso quedó listo para vender en tiempo récord. Gracias!"</p>
            </div>
        `;
    }, 1000);
}
